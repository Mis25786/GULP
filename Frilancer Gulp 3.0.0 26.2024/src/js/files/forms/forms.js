...
export function formFieldsInit(
	...
	//todo Якщо увімкнено, додаємо функціонал "Показати пароль"
	if (options.viewPass) {
	...
	//todo Якщо увімкнено, додаємо функціонал "Автовисота"
...
export function formSubmit() {
	...
	//todo Дії після надсилання форми
	function formSent(form, responseResult = ``) {
		...
		//todo Показуємо попап, якщо підключено модуль попапів
		//todo та для форми вказано налаштування
		setTimeout(() => {
			if (flsModules.popup) {
...
export function formRating() {
	...
	function initRatings() {
		...
		//todo Можливість вказати оцінку
		...
		async function setRatingValue(value, rating) {
			if (!rating.classList.contains('rating_sending')) {
				...
				//todo Надсилання даних (value) на сервер
